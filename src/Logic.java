    ...
    public void start() {
        ...
        if (userMode.equals("normal")) {
            ...
            if (game.getElement().equals("Light")) {
                ...
                System.out.println("Evil, menacing beast warriors from the Light Realm have been eradicating your mother land.");
                ...
                System.out.println("So, " + game.getPlayerName() + " will today be the day you raise your spear in victory over the vile dead bodies of your enemies?");
